...
Detecting human affective state requires large data sets to accurately classify affective states given the variability in emotions experienced within and between people. But the number of large-scale datasets for physiological signals is limited. Currently, this limitation necessitates feature engineering, where humans decide which features to extract from a dataset to feed into a machine learning model \cite{picard2000affective, spathis2020learning, schmidt2018introducing, goodwin2019predicting, thayer2022effects}.  
